...
Channel.value(params.mate).into{g_11_mate_g_82;g_11_mate_g15_9;g_11_mate_g53_9;g_11_mate_g1_0;g_11_mate_g1_5;g_11_mate_g1_7;g_11_mate_g9_11;g_11_mate_g9_9;g_11_mate_g9_12;g_11_mate_g13_10;g_11_mate_g13_12;g_11_mate_g13_14;g_11_mate_g12_15;g_11_mate_g12_19;g_11_mate_g12_12;g_11_mate_g84_0;g_11_mate_g84_1;g_11_mate_g84_8}
Channel.value(params.mate2).into{g_54_mate_g21_16;g_54_mate_g20_15;g_54_mate_g85_15}
...
output:
 set val(name),file("*_pair-pass.fastq")  into g53_9_reads0_g84_0
...
input:
 set val(name),file(reads) from g53_9_reads0_g84_0
 val mate from g_11_mate_g84_0

output:
 set val(name),file("*_align-pass.fastq")  into g84_0_reads0_g13_10
 set val(name), file("AS_*")  into g84_0_logFile1_g84_1
 set val(name),file("*_align-fail.fastq") optional true  into g84_0_reads_failed22
 set val(name), file("out*") optional true  into g84_0_logFile33
...
input:
 set val(name),file(reads) from g84_0_reads0_g13_10
...
output:
 set val(name),file("*_assemble-pass.f*")  into g12_12_reads0_g20_15
...
input:
 set val(name), file(reads) from g12_12_reads0_g20_15
...
output:
 file "*.html" optional true  into g13_20_outputFileHTML00
